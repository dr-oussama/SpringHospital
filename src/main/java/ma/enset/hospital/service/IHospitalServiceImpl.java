...
public class IHospitalServiceImpl implements IHospitalService {
    ...
    public IHospitalServiceImpl(PatientRepository patientRepository, MedecinRepository medecinRepository, RendezVousRepository rdvRepository, ConsultationRepository consultationRepository) {
